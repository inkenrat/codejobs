...
<div class="add-form">
	<form id="form-add" class="form-add" action="<?php echo $href; ?>" method="post" enctype="multipart/form-data">
		<fieldset>
			<legend><?php echo __(_("Add Work")); ?></legend>
			...
			<p class="field">
				&raquo; <?php echo __(_("Preview")); ?> 1<br />
			...
			<p class="field">
				&raquo; <?php echo __(_("Preview")); ?> 2<br />
			...
			<p class="field">
				&raquo; <?php echo __(_("Situation")); ?><br />
			...
			<p class="save-cancel">
				<input id="<?php echo $action; ?>" name="<?php echo $action; ?>" value="<?php echo __(_(ucfirst($action))); ?>" type="submit" class="submit save" tabindex="6" />
				<input id="cancel" name="cancel" value="<?php echo __(_("Cancel")); ?>" type="submit" class="submit cancel" tabindex="7" />
			</p>
